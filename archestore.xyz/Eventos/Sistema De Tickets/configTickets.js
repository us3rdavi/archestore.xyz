...
const CONFIG_STRING_SELECT_IDS = ['removerbotaoticketselect'];
...
module.exports = {
    ...
    run: async (interaction, client) => {
        if (interaction.isButton()) {
            ...
            if (interaction.customId === 'canalticketconfigsystem') {
                ...
                const cancelRow = new ActionRowBuilder().addComponents(
                    new ButtonBuilder()
                        .setCustomId('cancelarconfigticket')
                        .setLabel('Cancelar')
            ...
            if (interaction.customId === 'canallogsticket2') {
            ...
            if (interaction.customId === 'cargosstaff') {
            ...
            if (interaction.customId === 'configmensageminicial') {
                ...
                modal.addComponents(
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('titulo')
                            .setLabel('Título (use {numero} para o nº do ticket)')
                            .setPlaceholder('Ex: Ticket #{numero}')
                            .setValue(atual.msgTitulo || 'Ticket #{numero}')
                            .setMaxLength(100)
                    ...
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            ...
                            .setLabel('Descrição (aparece abaixo das informações)')
                            .setPlaceholder('Ex: Nossa equipe irá te atender em breve!')
                            .setValue(atual.msgDescricao || '')
                            .setMaxLength(500)
                    ...
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('banner')
                            .setLabel('URL do Banner (imagem no ticket)')
                            .setPlaceholder('https://exemplo.com/imagem.png')
                            .setValue(atual.msgBanner || '')
                            .setStyle(TextInputStyle.Short)
                            .setRequired(false)
                    ),
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('cor')
                            .setLabel('Cor de Destaque (hex)')
                            .setPlaceholder('Ex: #5865F2')
                            .setValue(atual.msgCor || '#5865F2')
                            .setMaxLength(7)
                            .setStyle(TextInputStyle.Short)
                            .setRequired(false)
                    ),
            ...
            if (interaction.customId === 'configmensagemfinal') {
                ...
                modal.addComponents(
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('titulo')
                            .setLabel('Título da mensagem de finalização')
                            .setPlaceholder('Ex: Ticket Marcado como Concluído')
                            .setValue(atual.titulo || 'Ticket Marcado como Concluído')
                            .setMaxLength(100)
                            .setStyle(TextInputStyle.Short)
                            .setRequired(true)
                    ),
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('descricao')
                            .setLabel('Descrição (instrução para o usuário)')
                            .setPlaceholder('Ex: Se resolvido, clique em Resolvido.')
                            .setValue(atual.descricao || '')
                            .setMaxLength(800)
                            .setStyle(TextInputStyle.Paragraph)
                            .setRequired(false)
                    ),
                    ...
                    new ActionRowBuilder().addComponents(
                        new TextInputBuilder()
                            .setCustomId('cor')
                            .setLabel('Cor de Destaque (hex)')
                            .setPlaceholder('Ex: #57F287')
                            .setValue(atual.cor || '#57F287')
                            .setMaxLength(7)
                            .setStyle(TextInputStyle.Short)
                            .setRequired(false)
                    ),
            ...
            if (interaction.customId === 'adicionarbotaoticket') {
                const modal = new ModalBuilder()
            ...
            if (interaction.customId === 'removerbotoesticket') {
                ...
                const select = new StringSelectMenuBuilder()
                    ...
                    .setMinValues(1)
                    .setMaxValues(botoesAdicionais.length)
                    .addOptions(
        ...
        if (interaction.isRoleSelectMenu()) {
            if (interaction.customId === 'selectcargosstaff') {
                ...
                const rolesMentions = roleIds.length > 0
