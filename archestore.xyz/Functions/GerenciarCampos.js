...
async function GerenciarCampos2(interaction, campo, produtoname, update, reply) {
    ...
    const infoCargosTemp24 = gggaaa.temprole24 ? `Tempo que o cargo <@&${gggaaa.roleadd}> Ira durar apôs a compra: ${gggaaa.temprole24}` : '';
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: `**Cargos**`,     value: `${infoCargosAdd}${bothUndefined ? 'Não Definido' : (infoCargosAdd && infoCargosTemp24 && infoCargosRemove ? '\n' : '')}${infoCargosTemp24 ? '\n' + infoCargosTemp24 : ''}${infoCargosRemove ? '\n' + infoCargosRemove : ''}`, inline: false },
